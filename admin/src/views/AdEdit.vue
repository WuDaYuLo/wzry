...
export default {
  ...
  methods:{
    async save(){
      // var res
      if(this.id){
       await this.$http.put(`rest/ads/${this.id}`,this.model) // eslint-disable-line no-unused-vars
      }else{
       await this.$http.post('rest/ads',this.model) // eslint-disable-line no-unused-vars
      }
      // console.log(res);
